...
namespace HtmlCssClassCompletion22
{
    class CompletionSource : IAsyncCompletionSource
    {
        ...
        public CompletionSource(ElementCatalog catalog, ITextStructureNavigatorSelectorService structureNavigatorSelector)
        {
            Catalog = catalog;
        ...
        public async Task<CompletionContext> GetCompletionContextAsync(IAsyncCompletionSession session, CompletionTrigger trigger, SnapshotPoint triggerLocation, SnapshotSpan applicableToSpan, CancellationToken token)
        {
            ...
            return await Task.FromResult(new CompletionContext(filteredList.ToImmutableArray()));
        }
